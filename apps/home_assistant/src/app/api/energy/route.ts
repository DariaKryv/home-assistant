export async function GET(request: Request) {
  ...
  const url = `https://uncommon-obviously-man.ngrok-free.app/api/history/period/${startTime}?end_time=${endTime}&filter_entity_id=sensor.electricity_meter_power_consumption&minimal_response`;
